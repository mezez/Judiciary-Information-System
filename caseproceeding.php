...
<!--                <div class="linetwo col-lg-12 col-md-12 col-sm-12">
                    <form class="form-inline" action="processproceeding.php?caseid=<?php var_dump($caseid);?>" method="post">
                         <div class="form-group ">
                                <label for="mezez">1. Charging In Court</label>
                                 <textarea class="form-control" rows="2" cols="70"  name="charging"></textarea>
                          </div><br><br>
                        <div class="form-group">
                                <label for="mezez">2. Plea:</label>
                                 <textarea class="form-control" rows="2" cols="70" id="casedeetail" name="plea"></textarea>
                              </select>
                          </div><br><br>
                          <div class="form-group">
                                <label for="mezez">3. Calling of Prosecution/Plaintiff Witness</label>
                                 <textarea class="form-control" rows="2" cols="70"  name="calling1"></textarea>
                          </div><br><br>
                          <div class="form-group">
                                <label for="mezez">4. Cross-examination of the Prosecution/Plaintiff Witness</label>
                                 <textarea class="form-control" rows="2" cols="70"  name="exam1"></textarea>
                          </div><br><br>
                          <div class="form-group">
                                <label for="mezez">5. Calling of Defendant Witness</label>
                                 <textarea class="form-control" rows="2" cols="70"  name="calling2"></textarea>
                          </div><br><br>
                          <div class="form-group">
                                <label for="mezez">6. Cross-examination of the Defendant Witness</label>
                                 <textarea class="form-control" rows="2" cols="70"  name="exam2"></textarea>
                          </div><br><br>
                          <div class="form-group">
                                <label for="mezez">7. Submission of Final Address By counsel to Defendant and Prosecution/Plaintiff respectively:</label>
                                 <textarea class="form-control" rows="2" cols="50"  name="submission"></textarea>
                          </div><br><br>
                          <div class="form-group">
                                <label for="mezez">8. Adjournment</label>
                                 <textarea class="form-control" rows="2" cols="70"  name="adjournment"></textarea>
                          </div><br><br>
                          <div class="form-group">
                                <label for="mezez">9. Interlocutory Sittings(IF ANY)</label>
                                 <textarea class="form-control" rows="5" cols="50"  name="interlocutory"></textarea>
                          </div><br><br>
                           <div class="form-group">
                                <label for="mezez">10. Judgement Day</label>
                                 <textarea class="form-control" rows="5" cols="50"  name="judgement"></textarea>
                          </div><br><br>
