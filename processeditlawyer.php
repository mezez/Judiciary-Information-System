 ...
 <body>
        <div class="container">
            <div class="wrapper">
                ...
                <?php
                                         $id = $_GET['id'];
                                          $sql_sel="SELECT * FROM lawyer WHERE id = $id LIMIT 1";
                                             $result = mysql_query($sql_sel);
                                              if(isset($result))
                                              {
                                                  $retrieved_lawyer = mysql_fetch_array($result);
                                              }
				  ...
				  <div class="container-fluid ">
				    ...
				    <div class="collapse navbar-collapse" id="myNavbar">
				      <ul class="nav navbar-nav navbar-left">
                                          ...
                                          <li class="active"><a href="processeditlawyer.php">EDIT LAWYER</a></li>
                                        </ul>    
                                          <ul class="nav navbar-nav navbar-right">
                                              <li><a href="showlawyer.php">BACK</a></li>
                 ...
                 <div>
                      <form class="form-horizontal" action="editlawyer.php?id=<?php echo $id;?>"  method="post">
                            
                            <div class="fline col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group col-lg-6 col-md-12 col-sm-12">
                              <label for="mezez">Lawyer Name </label> 
                              <input type="text" class="form-control" id="cfn" value="<?php echo $retrieved_lawyer['name'];?>" name="name">
                            </div>
                            </div>    
                            <br>
                            <br>
                            ...
                            <div class="form-group col-lg-6 col-md-12 col-sm-12">
                              ...
                              <input type="text" class="form-control" id="dfn" value="<?php echo $retrieved_lawyer['username'];?>" name="uname">
                            </div>
                            </div>    
                            <br>
                            <br>    
                            ...
                            <div class="form-group col-lg-6 col-md-12 col-sm-12">
                              ...
                              <input type="number" class="form-control" id="dt" name="phone" value="<?php echo $retrieved_lawyer['phone'];?>">
                            </div>
                            </div>    
                            <br>
                            <br>
