...
<link rel="stylesheet" type="text/css" href="css/suitnumber.css">
 <body>
        <div class="container">
            <div class="wrapper">
                <div class="row fline">
				  ...
				  <div class="container-fluid ">
				    ...
				    <div class="collapse navbar-collapse" id="myNavbar">
				      <ul class="nav navbar-nav navbar-left">
                                          ...
                                          <li class="active"><a href="suitnumber.php">SUIT NO</a></li>
                                        </ul>    
                     ...
                     <div class="lineone col-lg-12 col-sm-12 col-md-12">
                         <form class="form-horizontal" role="form" action="processsuitno.php" method="post">
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="username">Enter Suit No:</label>
                              <div class="col-sm-10 col-lg-6">
                                  <input type="name" class="form-control" id="username" placeholder="Suit Number" name="suitno">
                              </div>
                            </div>
