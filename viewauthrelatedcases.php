				  ...
				  <div class="container-fluid ">
				    ...
				    <div class="collapse navbar-collapse" id="myNavbar">
				      <ul class="nav navbar-nav navbar-left">
                                          ...
                                          <li class="active"><a href="viewauthrelatedcases.php">CASE DETAILS</a></li>
                                        </ul>    
                                          <ul class="nav navbar-nav navbar-right">
                                              <li><a href='authrelatedcases.php'>BACK</a>";?></li>
                 
                                              <li><a href="authorized.php">AUTHORIZED HOME</a></li>
