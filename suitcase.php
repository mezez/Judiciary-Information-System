				  ...
				  <div class="container-fluid ">
				    ...
				    <div class="collapse navbar-collapse" id="myNavbar">
				      <ul class="nav navbar-nav navbar-left">
                                          ...
                                          <li class="active"><a href="suitcase.php">SUIT NUMBER</a></li>
                                        </ul>    
                                          <ul class="nav navbar-nav navbar-right">
                                              <li><a href="suitnumber.php">BACK</a></li>
                        ...
                        <?php
                              $id = mysql_real_escape_string($_GET['suitno']);
                              echo '<div class="well col-sm-12 col-md-12 col-lg-12 lineone">';
                              $displaycase = new CaseClass();
                              $displaycase->DisplayRelatedCases($id);
                              echo '</div>';
                        ?>
